(function () {ww.
  ...
  .service('commonServices', ['$http', '$q', function($http, $q){
    ...
    this.apiUrls = {
	  ...
	  entities : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/entities/',
	  modifiedResidues : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/modified_AA_or_NA/',
	  mutatedResidues : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/mutated_AA_or_NA/',
	  polymerCoverage : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/polymer_coverage/',
	  polymerCoveragePerChain: 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/polymer_coverage/',
	  bindingSites : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/binding_sites/',
	  mappings : 'https://www.ebi.ac.uk/pdbe/api/mappings/',
	  residueListing : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/residue_listing/',
	  secStrutures : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/secondary_structure/',
	  outliers : 'https://www.ebi.ac.uk/pdbe/api/validation/residuewise_outlier_summary/entry/',
	  topology : 'https://www.ebi.ac.uk/pdbe/api/topology/entry/',
	  molecules : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/molecules/',
	  uniProtToPfam : 'https://www.ebi.ac.uk/pdbe/api/mappings/uniprot_to_pfam/',
	  observedResidueRatio: 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/observed_residues_ratio/',
	  edm: 'https://www.ebi.ac.uk/pdbe/coordinates/files/',
	  edm_diff: 'https://www.ebi.ac.uk/pdbe/coordinates/files/',
	  uniprotSegments : 'https://www.ebi.ac.uk/pdbe/api/mappings/uniprot_segments/',
	  residueListingPerChain : 'https://www.ebi.ac.uk/pdbe/api/pdb/entry/residue_listing/',
	  bestStructures : 'https://www.ebi.ac.uk/pdbe/api/mappings/best_structures/',
  ...
  angular.module('pdb.sequence.view.services', ['pdb.common.services'])
	.service('seqViewerService', ['$http', '$q', '$filter', 'commonServices', function($http, $q, $filter, commonServices){
		
		this.pathColorIndex = 0;
		
		this.setPathColorIndex = function(count){
		  this.pathColorIndex = count;
		}
